...
(function() {
  ...
  init_forces = function(go) {
    return [["runner", "runner", run_run], ["runner", "chaser", mob_mob], ["chaser", "runner", mob_mob], ["chaser", "chaser", mob_mob], ["runner", "chaser", run_cha], ["runner", "dante", run_pla], ["chaser", "dante", cha_pla], ["chaser", "repulsor", mob_rep], ["runner", "repulsor", run_pla], ["runner", "attractor", mob_att], ["chaser", "attractor", mob_att], ["chaser", "seed", cha_pla], ["runner", "seed", cha_pla]];
  };
  ...
  spawn_mob = function(go, t) {
    ...
    name = t + '_' + go.t;
    if (r > 5) {
      return go.sprites[name] = init_sprite(name, p.cx, p.cy, r, mp[t][1], t);
    }
  };
      ...
      results.push((function() {
        ...
        for (k = 0, len1 = pairs.length; k < len1; k++) {
          ...
          if ((pair[0] != null) && (pair[1] != null)) {
            results1.push(apply_force(go, pair, f[2]));
          } else {
            results1.push(void 0);
          }
        }
